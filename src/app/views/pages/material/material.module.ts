...
/************** Social media Callback Component ***************/
import { GoogleCallbackComponent } from './layout/GoogleCallback/googlecallback.component';
import { TwitterCallbackComponent } from './layout/TwitterCallback/twitterCallback.component';
import { DialogOverviewExampleDialog } from './layout/expansion-panel/expansion-panel.component';
import { ConfirmationDialogComponent } from './layout/ConfirmationDialog/confirmation_dialog.component';
import { ConfirmationDialogService } from './layout/ConfirmationDialog/confirmation_dialog.service';
...
const routes: Routes = [
	{
		...
		children: [
			...
			{
				path: 'layout/GoogleCallback',
				component: GoogleCallbackComponent
			},
			{
				path: 'layout/TwitterCallback',
